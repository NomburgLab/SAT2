...
class Test_Struc_Get_Domains_Main():
    ...
    def test_min_length(self,tmp_path):
        ...
        args.chainsaw_file_path = ("tests/test_data/structure_related/get_domains_chainsaw/input_min_length/chainsaw_file_min_length_test.txt")
        args.min_domain_length = 5
    ...
    def test_struc_get_domains_main_(self, tmp_path):
        ...
        args.outfile_dir = tmp_path/"test_output"
        args.outfile_dir.mkdir()
        expected_outfile_dir = Path("tests/test_data/structure_related/get_domains_chainsaw/output_extract_all")

        # Running script
        pdb_file_folder = Path("tests/test_data/structure_related/get_domains_chainsaw/input_extract_all/")
